module.exports = {
  Ctor: require('passport-bitbucket-oauth2').Strategy,
  getConfig: (env) => {
    const clientID = env.auth.bitbucket.clientID;
    const clientSecret = env.auth.bitbucket.clientSecret;
    const callbackURL = env.auth.bitbucket.callbackURL;
